...
{
  fprintf(stderr, "bx_begin_simulation 1\n");
  if (SIM->get_param_bool(BXPN_RESTORE_FLAG)->get()) {
...
fprintf(stderr, "bx_begin_simulation 2\n");
  ...
  fprintf(stderr, "bx_begin_simulation 3\n");
...
fprintf(stderr, "bx_begin_simulation 4\n");
  bx_init_hardware();

  fprintf(stderr, "bx_begin_simulation 5\n");
  ...
  fprintf(stderr, "bx_begin_simulation 6\n");
...
void bx_init_hardware()
{
  ...
  fprintf(stderr, "bx_init_hardware 1\n");
  ...
  fprintf(stderr, "bx_init_hardware 2\n");

  bx_pc_system.initialize(SIM->get_param_num(BXPN_IPS)->get());

  fprintf(stderr, "bx_init_hardware 3\n");
  ...
  fprintf(stderr, "bx_init_hardware 4\n");

  io->set_log_prefix(SIM->get_param_string(BXPN_LOG_PREFIX)->getptr());

  fprintf(stderr, "bx_init_hardware 5\n");
  ...
  fprintf(stderr, "bx_init_hardware 6\n");
  ...
  fprintf(stderr, "bx_init_hardware 7\n");
  ...
  fprintf(stderr, "bx_init_hardware 8\n");
  ...
  fprintf(stderr, "bx_init_hardware 9\n");
  ...
  fprintf(stderr, "bx_init_hardware 10\n");

  BX_MEM(0)->init_memory(memSize, hostMemSize);

  fprintf(stderr, "bx_init_hardware 11\n");
  ...
  fprintf(stderr, "bx_init_hardware 12\n");
  ...
  fprintf(stderr, "bx_init_hardware 13\n");
  ...
  fprintf(stderr, "bx_init_hardware 14\n");
  ...
  fprintf(stderr, "bx_init_hardware 15\n");
  ...
  fprintf(stderr, "bx_init_hardware 16\n");

  DEV_init_devices();

  fprintf(stderr, "bx_init_hardware 17\n");
  ...
  fprintf(stderr, "bx_init_hardware 18\n");
  ...
  fprintf(stderr, "bx_init_hardware 19\n");

  bx_gui->init_signal_handlers();
  bx_pc_system.start_timers();

  fprintf(stderr, "bx_init_hardware 20\n");
...
// if not using debugger, then we can take control of SIGINT.
  ...
  fprintf(stderr, "bx_init_hardware 21\n");
/*
#if BX_SHOW_IPS
#if !defined(WIN32)
...
#endif
*/
  fprintf(stderr, "bx_init_hardware 22\n");
}
