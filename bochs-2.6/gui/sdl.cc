/////////////////////////////////////////////////////////////////////////
// $Id: sdl.cc 11370 2012-08-26 12:32:10Z vruppert $
/////////////////////////////////////////////////////////////////////////
//
...
fprintf(stderr, "sdl mode1: %d %d\n", res_x,res_y+headerbar_height+statusbar_height);
    ...
    unsigned fheight, unsigned fwidth, unsigned bpp)
{
  ...
  half_res_x = x/2;
  half_res_y = y/2;
  fprintf(stderr, "show header bar:\n");
  bx_gui->show_headerbar();
  fprintf(stderr, "show header bar: done\n");
}
